...
$email_msg = "
<h1>News with Singapura in Indo media</h1>
...
for ($x = 0; $x < count($all_saved_file); $x++) {
  ...
  if ($all_saved_file[$x]['date'] == $today) {
  echo "<tr>";
...
$headers .= "Reply-To: Azman <webmaster@thekazrah.com>\r\n";
$headers .= "Return-Path: Azman <webmaster@thekazrah.com>\r\n";
...
mail("khairul.azman.rahmat@gmail.com","Indonesian News",$email_msg, $headers);
mail("caixihao@gmail.com","Indonesian News",$email_msg, $headers);
mail("Yeeler17@gmail.com","Indonesian News",$email_msg, $headers);
mail("tan.wenyi90@gmail.com","Indonesian News",$email_msg, $headers);
mail("yiyime2@gmail.com","Indonesian News",$email_msg, $headers);
mail("matthewchan.th@gmail.com","Indonesian News",$email_msg, $headers);
